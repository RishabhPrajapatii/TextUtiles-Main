    ...
    <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <label className="btn btn-primary" htmlFor="btnradio1">Blue mode</label> */}

          {/* <input type="radio" className="btn-check" onClick={props.rtoggleMode} name="btnradio" id="btnradio2" autocomplete="off" />
          <label className="btn btn-danger" htmlFor="btnradio2">Red mode</label>

          <input type="radio" className="btn-check" onClick={props.gtoggleMode} name="btnradio" id="btnradio3" autocomplete="off" />
          <label className="btn btn-success" htmlFor="btnradio3">Green mode</label> */}
